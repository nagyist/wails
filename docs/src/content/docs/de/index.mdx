...
Weiter: [Erstelle eine vollständige Anwendung](/tutorials/03-notes-vanilla), durchsuche [Beispiele](https://github.com/wailsapp/wails/tree/master/v3/examples) oder sieh dir die [API-Referenz](/reference/application) an. Migration von v2? Siehe [Upgrade-Leitfaden](/migration/v2-to-v3).
